...
names.arg=c("PHQ","AES-Behaviour","AES-Cognition","AES-Emotion","AES-other", "SHAPS-Social","SHAPS-Food","SHAPS-Perceptual","SHAPS-PastTime","DOPS-PersonnalAchievement","DOPS-Sex","DOPS-Social","DOPS-Perceptual","LifeHappiness","CurrentHappiness"),las=1,cex.axis=1.7,cex.names=1.7,cex.lab=2.2,cex.main=2.2)
...
labs(x="Standardised Reward sensitivity",y="Standardised Mental Health score")+
